...
\hypersetup{colorlinks,linkcolor=Poppy,urlcolor=Blue,citecolor=Blue}
% \setbeamercolor{frametitle}{bg=Cardinal Red, fg=Blue}


\setbeamercolor{palette primary}{bg=Sky, fg=Fog}
% \setbeamercolor{palette secondary}{bg=}
\setbeamercolor{frametitle}{bg=Sky,fg=Fog}
% \setbeamercolor{titlepage}{bg=Poppy,fg=Fog}
