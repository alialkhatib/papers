...
\setbeamercolor{normal text}{fg=Black,bg=Fog}
\hypersetup{colorlinks,linkcolor=Lagunita,urlcolor=Lagunita,citecolor=Lagunita}

\setbeamercolor{palette primary}{bg=Lagunita, fg=Fog}
% \setbeamercolor{palette secondary}{bg=Poppy}
\setbeamercolor{frametitle}{bg=Lagunita,fg=Fog}

% \setbeamercolor{section title}{fg=Dark Red, bg=Fog}
\setbeamercolor{alerted text}{fg=Poppy}
