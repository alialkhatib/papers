...
% Why have I been irritated the last five years?
...
\againframe<1>[standout]{juxtapose}
...
\date{}
% \subtitle{}
\subtitle{Using Intellectual Arbitrage to Study \onslide<0>{Technical} Systems}
\titlepage

% {\strong{\Large Street-level algorithms}

% {\large Using intellectual arbitrage to understand systems we make}}
