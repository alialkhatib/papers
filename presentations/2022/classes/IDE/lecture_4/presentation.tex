...
\only<+>{\includegraphics[width=\textwidth]{figures/videos/ghost_work/cover.png}}

\only<+>{\includegraphics[width=\textwidth]{figures/videos/ghost_work/mixed.png}}

\only<+>{\includegraphics[width=\textwidth]{figures/videos/ghost_work/crowdwork.png}}

\only<+>{\includegraphics[width=\textwidth]{figures/videos/ghost_work/gig.png}}

\only<+>{\includegraphics[width=\textwidth]{figures/videos/ghost_work/gigcrowd.png}}
\end{column}
...
\begin{frame}[plain]
    \only<+>{\includegraphics[width=\textwidth]{figures/videos/ghost_work/humanComp.png}}

    \only<+>{\includegraphics[width=\textwidth]{figures/videos/ghost_work/piecework.png}}
