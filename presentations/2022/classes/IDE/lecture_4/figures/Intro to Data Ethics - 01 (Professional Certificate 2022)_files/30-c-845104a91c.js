...
c["a"].removePlaceholders(e)}}function W(e,t,n){const o=[]
o.push(M(e))
...
return o}function q(e,t){const n=Object(s["a"])(e)
...
i.editor.selection.moveToBookmark(t.bookmark)}const r=q({contextType:l,contextId:s,...n},e)
t.bookmark&&i.editor.selection.moveToBookmark(o)
return r}).then(e=>{n(W(e,t,l))}).catch(e=>{n(H(t.name))
...
const[H,W]=Object(o["useState"])(D)
const[q,V]=Object(o["useState"])(F)
const[G,K]=Object(o["useState"])(t.tracks||[])
const[Z]=Object(o["useState"])(E["e"])
const[Y]=Object(o["useState"])(Math.round(H/q*E["e"]))
...
const ae=[]
U!==E["a"]&&ae.push({text:Object(A["a"])("{width} x {height}px",{height:H,width:q}),type:"hint"})
...
n.sanitizeURL&&(t=""+t)
return e+'="'+$(t)+'"'}return R(e)?e+'="'+$(t)+'"':""}function W(e,t){return e===t&&(0!==e||1/e===1/t)||e!==e&&t!==t}var q="function"===typeof Object.is?Object.is:W,V=null,G=null,K=null,Z=!1,Y=!1,X=null,J=0
...
var $=n("n12J")
var H=n("eGSd")
function W(e){const t=document.cookie.match("(^|[^;]+)\\s*"+e+"\\s*=\\s*([^;]+)")
return t?decodeURIComponent(t.pop()):void 0}var q=n("NFDp")
var V=n("TSYQ")
var G=n.n(V)
var K=n("b5/e")
var Z=n("GEYT")
...
var We=function(e){Object(D["a"])(n,e)
var t=Object(F["a"])(n)
function n(){Object(B["a"])(this,n)
...
return n}function _(){return a.a.createElement($["a"],{"data-testid":"whole-status-bar-path"},ot(e))}function m(){const t=Object(q["a"])("Accessibility Checker")
...
if(!e.use_rce_a11y_checker_notifications||e.a11yErrorsCount<=0)return o
return a.a.createElement(L["a"],{theme:{[Ue["a"].theme]:{colorPrimary:e.a11yBadgeColor}}},a.a.createElement(Ue["a"],{count:e.a11yErrorsCount,countUntil:100},o))}function p(){const t=e.editorView===tt?Object(q["a"])("Sadly, the pretty HTML editor is not keyboard accessible. Access the raw HTML editor here."):Object(q["a"])("Access the pretty HTML editor")
const o=e.editorView===tt?Object(q["a"])("Raw HTML Editor"):Object(q["a"])("Pretty HTML Editor")
...
const t=Object(q["a"])("View keyboard shortcuts")
...
const t=Object(q["a"])("{count, plural,\n         =0 {0 words}\n        one {1 word}\n      other {# words}\n    }",{count:e.wordCount})
return a.a.createElement($["a"],{display:"inline-block",padding:"0 small","data-testid":"status-bar-word-count"},a.a.createElement($e["a"],null,t))}function y(){return s()===nt?Object(q["a"])("Shift-O to open the pretty html editor."):Object(q["a"])("The pretty html editor is not keyboard accessible. Press Shift O to open the raw html editor.")}function b(){const t=Object(q["a"])("Switch to the html editor")
const i=Object(q["a"])("Switch to the rich text editor")
const r=Object(q["a"])("Click or shift-click for the html editor.")
const c=u()?i:t
const d=u()?i:r
...
var ht=n("Dibh")
var yt=n("Mmr1")
function bt(e){return a.a.createElement(ht["a"],{"data-testid":"RCE_KeyboardShortcutModal","data-mce-component":true,label:Object(q["a"])("Keyboard Shortcuts"),open:e.open,shouldCloseOnDocumentClick:true,shouldReturnFocus:true,size:"auto",onClose:e.onClose,onExited:e.onExited,onDismiss:e.onDismiss},a.a.createElement(ht["a"].Header,null,a.a.createElement(yt["a"],{placement:"end",offset:"medium",variant:"icon",onClick:e.onDismiss},Object(q["a"])("Close")),a.a.createElement(pt["a"],null,Object(q["a"])("Keyboard Shortcuts"))),a.a.createElement(ht["a"].Body,null,a.a.createElement($["a"],{as:"div",margin:"small"},a.a.createElement(ft["a"],{variant:"unstyled"},a.a.createElement(ft["a"].Item,null,a.a.createElement($e["a"],{weight:"bold"},"ALT+F8/ALT+0")," ",Object(q["a"])("Open this keyboard shortcuts dialog")),a.a.createElement(ft["a"].Item,null,a.a.createElement($e["a"],{weight:"bold"},"CTRL+F9")," ",Object(q["a"])("Focus element options toolbar")),a.a.createElement(ft["a"].Item,null,a.a.createElement($e["a"],{weight:"bold"},"ALT+F9")," ",Object(q["a"])("Go to the editor's menubar")),a.a.createElement(ft["a"].Item,null,a.a.createElement($e["a"],{weight:"bold"},"ALT+F10")," ",Object(q["a"])("Go to the editor's toolbar")),a.a.createElement(ft["a"].Item,null,a.a.createElement($e["a"],{weight:"bold"},"ESC")," ",Object(q["a"])("Close a menu or dialog. Also returns you to the editor area")),a.a.createElement(ft["a"].Item,null,a.a.createElement($e["a"],{weight:"bold"},Object(q["a"])("TAB/Arrows"))," ",Object(q["a"])("Navigate through the menu or toolbar"))),a.a.createElement($["a"],{as:"p"},Object(q["a"])("Other editor shortcuts may be found at")," ",a.a.createElement("a",{href:"https://www.tiny.cloud/docs/advanced/keyboard-shortcuts/",target:"rcekbshortcut"},"https://www.tiny.cloud/docs/advanced/keyboard-shortcuts/")))))}bt.propTypes={open:o["bool"].isRequired,onClose:o["func"],onDismiss:o["func"].isRequired,onExited:o["func"]}
...
var kt=n("G1G5")
var Ct,Ot,Et,At
const St=a.a.lazy(()=>n.e(4167).then(n.bind(null,"L5Z7")))
const jt=a.a.lazy(()=>Promise.all([n.e(3694),n.e(4134)]).then(n.bind(null,"GuXJ")))
const It=250
const Lt="400px"
...
e.setItem(t,t)
e.removeItem(t)
return true}catch(t){return t instanceof DOMException&&(22===t.code||1014===t.code||"QuotaExceededError"===t.name||"NS_ERROR_DOM_QUOTA_REACHED"===t.name)&&e&&0!==e.length}}function Gt(){const e=W("rce.htmleditor")
return e===nt||e===tt?e:tt}function Kt(){return Object(q["a"])("Loading")}const Zt=void 0===document.fullscreenElement?"webkitFullscreenElement":"fullscreenElement"
...
if(r){r.setAttribute("aria-label",Object(q["a"])("Rich Content Editor"))
...
this.props.use_rce_a11y_checker_notifications&&t.on("Cut Paste Change input Undo Redo",Object(H["a"])(this.handleInputChange,1e3))
...
this.a11yCheckerReady=Promise.all([n.e(11),n.e(21),n.e(22),n.e(24),n.e(26),n.e(4118)]).then(n.bind(null,"sOmF")).then(e=>{e.default(this.language)
...
this.mceInstance().dom.doc.querySelector("[data-placeholder-for]")&&(t=e(Object(q["a"])("Content is still being uploaded, if you continue it will not be embedded properly.")))
...
if(o){o.hasAttribute("title")||o.hasAttribute("aria-label")||o.setAttribute("title",Object(q["a"])("embedded content"))
...
if(Object(wt["k"])(t,e)){if(1!==this.announcing){this.setState({announcement:Object(q["a"])("type Control F9 to access image options. {text}",{text:t.getAttribute("alt")})})
this.announcing=1}}else if(Object(wt["j"])(t,e)){if(2!==this.announcing){this.setState({announcement:Object(q["a"])("type Control F9 to access link options. {text}",{text:t.textContent})})
this.announcing=2}}else if(qt(t,e)){if(3!==this.announcing){this.setState({announcement:Object(q["a"])("type Control F9 to access table options. {text}",{text:t.textContent})})
...
const s={...e,readonly:this.props.readOnly,theme:"silver",height:e.height||Lt,language:Oe()(this.language),block_formats:e.block_formats||[Object(q["a"])("Heading 2")+"=h2",Object(q["a"])("Heading 3")+"=h3",Object(q["a"])("Heading 4")+"=h4",Object(q["a"])("Preformatted")+"=pre",Object(q["a"])("Paragraph")+"=p"].join("; "),setup:e=>{var t
Pt(e)
$t.set(e,this)
...
"function"===typeof r&&r(e)},content_css:e.content_css||[],content_style:zt,menubar:en("edit view insert format tools table",c),menu:tn({format:{title:Object(q["a"])("Format"),items:"bold italic underline strikethrough superscript subscript codeformat | formats blockformats fontformats fontsizes align directionality | forecolor backcolor | removeformat"},insert:{title:Object(q["a"])("Insert"),items:"instructure_links instructure_image instructure_media instructure_document instructure_buttons | instructure_equation inserttable instructure_media_embed | hr"},tools:{title:Object(q["a"])("Tools"),items:"wordcount lti_tools_menuitem"},view:{title:Object(q["a"])("View"),items:"fullscreen instructure_html_view"}},e.menu),toolbar:nn([{name:Object(q["a"])("Styles"),items:["fontsizeselect","formatselect"]},{name:Object(q["a"])("Formatting"),items:["bold","italic","underline","forecolor","backcolor","inst_subscript","inst_superscript"]},{name:Object(q["a"])("Content"),items:["instructure_links","instructure_image","instructure_record","instructure_documents","instructure_buttons"]},{name:Object(q["a"])("External Tools"),items:[...this.ltiToolFavorites,"lti_tool_dropdown","lti_mru_button"]},{name:Object(q["a"])("Alignment and Lists"),items:["align","bullist","inst_indent","inst_outdent"]},{name:Object(q["a"])("Miscellaneous"),items:["removeformat","table","instructure_equation","instructure_media_embed"]}],e.toolbar),contextmenu:"",toolbar_mode:"floating",toolbar_sticky:true,plugins:on(["autolink","media","paste","table","link","directionality","lists","textpattern","hr","fullscreen","instructure-ui-icons","instructure_condensed_buttons","instructure_links","instructure_html_view","instructure_media_embed","instructure_external_tools","a11y_checker","wordcount",...a],Ae(e.plugins)),textpattern_patterns:[{start:"* ",cmd:"InsertUnorderedList"},{start:"- ",cmd:"InsertUnorderedList"}]}
...
this.ltiToolFavorites.length>0&&n.e(3714).then(n.bind(null,"DiQt"))
...
t.forEach(t=>{const n=e.find(e=>t.name&&Object(q["a"])(t.name)===e.name)
...
var H=n("wnpG")
var W=function(e={},t){switch(t.type){case H["c"]:return{...e,searching:true,searchTerm:t.term}
...
var q=n("XXvC")
const V={}
function G(e=V,t){switch(t.type){case q["a"]:return{...e,...t.data}
...
return e}var ne=Object(l["combineReducers"])({ui:p,source:d,jwt:d,host:d,containingContext:d,contextType:Y,contextId:X,searchString:J,sortBy:Q,all_files:te,collections:b,files:v,folders:C,rootFolderId:O,images:S,documents:I,media:T,upload:$,flickr:W,session:G,newPageLinkExpanded:Z})
var oe=n("n/1O")
...
switch(e){case"ar":i=n.e(4214).then(n.bind(null,"venI"))
break
case"ca":i=n.e(4215).then(n.bind(null,"1Y6O"))
break
case"cy":i=n.e(4216).then(n.bind(null,"we+z"))
break
case"da":i=n.e(4218).then(n.bind(null,"PTiq"))
break
case"da-x-k12":i=n.e(4217).then(n.bind(null,"yNIZ"))
break
case"de":i=n.e(4219).then(n.bind(null,"S8cF"))
break
case"el":i=n.e(4220).then(n.bind(null,"FwcW"))
break
case"en":i=n.e(4336).then(n.bind(null,"NQfO"))
break
case"en-AU-x-unimelb":i=n.e(4221).then(n.bind(null,"3W0S"))
break
case"en-GB-x-ukhe":i=n.e(4222).then(n.bind(null,"KQzV"))
break
case"en-AU":i=n.e(4223).then(n.bind(null,"voS+"))
break
case"en-CA":i=n.e(4337).then(n.bind(null,"m+Mn"))
break
case"en-CY":i=n.e(4338).then(n.bind(null,"mgnU"))
break
case"en-GB":i=n.e(4224).then(n.bind(null,"nxzM"))
break
case"es":i=n.e(4225).then(n.bind(null,"2MaM"))
break
case"es-ES":i=n.e(4226).then(n.bind(null,"HM1o"))
break
case"fa-IR":i=n.e(4227).then(n.bind(null,"01hr"))
break
case"fi":i=n.e(4228).then(n.bind(null,"QFVQ"))
break
case"fr":i=n.e(4229).then(n.bind(null,"8o6s"))
break
case"fr-CA":i=n.e(4230).then(n.bind(null,"Bm8W"))
break
case"he":i=n.e(4231).then(n.bind(null,"mYM8"))
break
case"ht":i=n.e(4339).then(n.bind(null,"ZkKP"))
break
case"hu":i=n.e(4232).then(n.bind(null,"sbbs"))
break
case"hy":i=n.e(4233).then(n.bind(null,"WoYt"))
break
case"is":i=n.e(4340).then(n.bind(null,"/C+o"))
break
case"it":i=n.e(4234).then(n.bind(null,"Qvrh"))
break
case"ja":i=n.e(4235).then(n.bind(null,"XZYX"))
break
case"ko":i=n.e(4236).then(n.bind(null,"vrKU"))
break
case"mi":i=n.e(4341).then(n.bind(null,"LP6z"))
break
case"nb":i=n.e(4238).then(n.bind(null,"Uc+e"))
break
case"nb-x-k12":i=n.e(4237).then(n.bind(null,"56N6"))
break
case"nl":i=n.e(4239).then(n.bind(null,"17Or"))
break
case"nn":i=n.e(4240).then(n.bind(null,"HZtm"))
break
case"pl":i=n.e(4241).then(n.bind(null,"JcWQ"))
break
case"pt":i=n.e(4242).then(n.bind(null,"I9Ke"))
break
case"pt-BR":i=n.e(4243).then(n.bind(null,"7P9b"))
break
case"ru":i=n.e(4244).then(n.bind(null,"V5X0"))
break
case"se":i=n.e(4342).then(n.bind(null,"JKpP"))
break
case"sl":i=n.e(4245).then(n.bind(null,"h8aU"))
break
case"sv":i=n.e(4247).then(n.bind(null,"lfo/"))
break
case"sv-x-k12":i=n.e(4246).then(n.bind(null,"4MO5"))
break
case"th":i=n.e(4248).then(n.bind(null,"TDbP"))
break
case"tr":i=n.e(4249).then(n.bind(null,"V0pu"))
break
case"uk-UA":i=n.e(4250).then(n.bind(null,"yL5t"))
break
case"vi":i=n.e(4251).then(n.bind(null,"rGya"))
break
case"zh":i=n.e(4254).then(n.bind(null,"Sx0h"))
break
case"zh-Hans":i=n.e(4252).then(n.bind(null,"32vL"))
break
case"zh-Hant":i=n.e(4253).then(n.bind(null,"Iyx8"))
break
case"zh-HK":i=n.e(4255).then(n.bind(null,"v1QM"))
break
...
default:return Object(x["a"])("Tray")}}const z={icon_maker_icons:i.a.lazy(()=>Promise.all([n.e(13),n.e(85),n.e(4175)]).then(n.bind(null,"F/nJ"))),links:i.a.lazy(()=>n.e(4128).then(n.bind(null,"2k/U"))),images:i.a.lazy(()=>Promise.all([n.e(13),n.e(85),n.e(4184)]).then(n.bind(null,"ZXxL"))),documents:i.a.lazy(()=>n.e(4142).then(n.bind(null,"3R0a"))),media:i.a.lazy(()=>n.e(4143).then(n.bind(null,"bfKp"))),all:i.a.lazy(()=>Promise.all([n.e(28),n.e(65),n.e(82),n.e(4165)]).then(n.bind(null,"NhNB"))),unknown:i.a.lazy(()=>n.e(4335).then(n.bind(null,"G/Kj")))}
function P(e){let t=""
...
function W(e,t,n){if(null==e.source&&null==e[t])throw new Error(`The prop \`${t}\` is marked as required in \`${n}\`, but its value is \`${e[t]}\`.`)}const q={canUploadFiles:r["bool"].isRequired,contextId:r["string"].isRequired,contextType:r["string"].isRequired,containingContext:Object(r["shape"])({contextType:r["string"].isRequired,contextId:r["string"].isRequired,userId:r["string"].isRequired}),filesTabDisabled:r["bool"],host:W,jwt:W,refreshToken:r["func"],source:Object(r["shape"])({fetchImages:r["func"].isRequired}),themeUrl:r["string"]}
const V=Object(r["shape"])(q)
H.propTypes={bridge:Object(r["instanceOf"])(m["a"]).isRequired,editor:Object(r["shape"])({id:r["string"]}).isRequired,onTrayClosing:r["func"],...q}
...
const o=`${n}?id=${e}`
return this.apiFetch(o,t,{skipParse:true})}getFile(e){const t=u(this.jwt)
const n=this.baseUri("file")
const o=`${n}/${e}`
return this.apiFetch(o,t).then(p)}async apiFetch(e,t,n){this.hasSession||await this.getSession()
...
//# sourceMappingURL=30-c-845104a91c.js.map