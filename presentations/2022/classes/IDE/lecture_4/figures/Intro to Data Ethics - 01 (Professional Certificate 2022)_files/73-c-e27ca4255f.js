...
this.loadRCE(e=>{e.renderIntoDiv(i,o,e=>{e.tinymceOn("init",()=>n(a,p.wrapEditor(e)))})})},loadingCallbacks:[],RCE:null,loadRCE(e=(()=>{})){return Promise.all([n.e(2),n.e(3),n.e(5),n.e(6),n.e(7),n.e(10),n.e(12),n.e(14),n.e(15),n.e(18),n.e(23),n.e(30),n.e(3748)]).then(n.bind(null,"j/Fk")).then(e=>{this.RCE=e
Object(m["a"])()
...
t.icon="lti_tool_"+t.id}t.iconSVG&&e.ui.registry.addIcon(t.icon,t.iconSVG)}function p(e,t){t.length&&e.ui.registry.addNestedMenuItem("lti_tools_menuitem",{text:h.t("Apps"),icon:"lti",getSubmenuItems:()=>w(e,t)})}function _(e,t){const n=h.t("Apps")
e.ui.registry.addButton("lti_tool_dropdown",{onAction:()=>{const e=new CustomEvent("tinyRCE/onExternalTools",{detail:{ltiButtons:t}})
document.dispatchEvent(e)},icon:"lti",tooltip:n,onSetup(t){l.showHideButtons(e)}})}function b(e,t){t.forEach(t=>{if(!t.favorite)return
f(e,t)
e.ui.registry.addButton("instructure_external_button_"+t.id,{onAction:t.onAction,tooltip:t.title,icon:t.icon,title:t.title})})}function v(e,t){const n=h.t("Apps")
e.ui.registry.addMenuButton("lti_mru_button",{tooltip:n,icon:"lti",fetch(n){n(w(e,t))},onSetup(t){l.showHideButtons(e)}})}function w(e,t){const n=[]
...
document.dispatchEvent(e)}})}return n}var y=g
var k=n("ik22")
var x=n("uloQ")
const R=Object(i["useScope"])("loadEventListeners")
...
e.equationCB(a)}).catch(Object(x["c"])(R.t("Something went wrong loading the equation editor")))})
...
e.equellaCB()}).catch(Object(x["c"])(R.t("Something went wrong loading Equella")))})
...
const t=e.src
e.src=t})}function k(e){const t=r.a.fudgeDateForProfileTimezone(e)
return t.toString("MMM d, yyyy h:mmtt")}function x(e){"string"===typeof e&&(e=Date.parse(e))
const t=new Date-e
...
return p.t("#time.count_hours_ago",{one:"1 hour ago",other:"%{count} hours ago"},{count:e})}}return k(e)}r()((function(){if(window._earlyClick){document.removeEventListener("click",window._earlyClick)
...
const s=o[1]
Promise.all([n.e(20),n.e(44),n.e(131),n.e(4135)]).then(n.bind(null,"i7z/")).then(e=>{e.showFilePreview(s,a)}).catch(e=>{r.a.flashError(p.t("Something went wrong loading the file previewer."))})}})
let t
r.a.subscribe("userContent/change",()=>{clearTimeout(t)
t=setTimeout(y,50)})
r()(document).bind("user_content_change",y)
r()(()=>{setInterval(y,15e3)
setTimeout(y,15)})
...
t.text(x(n))
t.attr("title",k(n))}setTimeout(s,1)}else setTimeout(o,6e4)}setTimeout(o,100)
...
Promise.all([n.e(9),n.e(193)]).then(n.bind(null,"fY8A")).then(()=>{t.moduleSequenceFooter({courseID:t.attr("data-course-id"),assetType:t.attr("data-asset-type"),assetID:t.attr("data-asset-id")})})}}r()("#right-side").delegate(".more_link","click",(function(e){const t=r()(this)
...
let[e,t]=Object(o["a"])(ENV.context_asset_string,false)
const n=ENV.current_user_id
const a={contextType:e,contextId:t,userId:n}
const r=ENV.RICH_CONTENT_CAN_UPLOAD_FILES
if(!r||"account"===e){t=n
...
//# sourceMappingURL=73-c-e27ca4255f.js.map