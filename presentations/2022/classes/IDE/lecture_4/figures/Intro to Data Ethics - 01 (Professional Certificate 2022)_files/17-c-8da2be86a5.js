...
var x=(M=Object(k["a"])(),I=Object(f["j"])(O,j),M(J=I(J=(S=W=function(e){Object(i["a"])(t,e)
var n=Object(s["a"])(t)
function t(e){var a
Object(r["a"])(this,t)
a=n.call(this)
...
a.updateSelected=function(e,n,t,r,i){var s=a.props.allowMultiple
var l=s?Object(o["a"])(t):[]
var c=l.indexOf(n)
true===r&&c<0?l.push(n):false===r&&-1!==c?l.splice(c,1):!s&&l.length<1&&(l=Object(o["a"])(t))
"function"===typeof a.props.onSelect&&a.props.onSelect(e,l,r,i)
return l}
...
var o=[]
var r=l["Children"].toArray(n).filter((function(e){return Object(b["a"])(e,[_["a"]])}))
...
return Object(y["a"])(e)?c.a.createElement("span",{className:j.label},e):e}},{key:"renderChildren",value:function(){var e=this
var n=this.props,t=n.children,o=n.disabled,r=n.controls,a=n.allowMultiple,i=n.isTabbable,s=n.onMouseOver
var u=-1
return l["Children"].map(t,(function(n){if(Object(b["a"])(n,[_["a"]])){++u
var t=n.props.value||u
return c.a.createElement("li",{role:"none"}," ",Object(v["a"])(n,{tabIndex:i&&0===u?0:-1,controls:r,value:t,type:a?"checkbox":"radio",ref:e.props.itemRef,disabled:o||n.props.disabled,selected:e.selected.indexOf(t)>-1,onSelect:e.handleSelect,onMouseOver:s})," ")}return n}))}},{key:"render",value:function(){var e=Object(m["a"])(this.props,t.propTypes)
return c.a.createElement("span",Object.assign({},e,{className:j.root,role:"presentation"}),c.a.createElement("span",{id:this._labelId},this.renderLabel()),c.a.createElement("ul",{role:"menu",className:j.items,"aria-disabled":this.props.disabled?"true":null,"aria-labelledby":this._labelId},this.renderChildren()))}},{key:"selected",get:function(){return"undefined"===typeof this.props.selected&&"undefined"===typeof this.state.selected?[]:"undefined"===typeof this.props.selected?Object(o["a"])(this.state.selected):Object(o["a"])(this.props.selected)}}])
t.displayName="MenuItemGroup"
return t}(l["Component"]),W.propTypes={label:d.a.node.isRequired,allowMultiple:d.a.bool,children:p["a"].oneOf([_["a"],G["a"]]),selected:Object(h["a"])(d.a.array,"onSelect","defaultSelected"),defaultSelected:d.a.array,onSelect:d.a.func,onMouseOver:d.a.func,onKeyDown:d.a.func,controls:d.a.string,itemRef:d.a.func,disabled:d.a.bool,isTabbable:d.a.bool},W.defaultProps={onMouseOver:void 0,disabled:false,controls:void 0,onKeyDown:void 0,selected:void 0,children:null,isTabbable:false,allowMultiple:false,defaultSelected:[],itemRef:function(e){},onSelect:function(e,n,t,o){}},S))||J)||J)},"8Q55":function(e,n,t){"use strict"
...
var v=(f=Object(u["a"])(),p=Object(c["j"])(d,b),f(h=p(h=function(e){Object(a["a"])(t,e)
var n=Object(i["a"])(t)
function t(){Object(o["a"])(this,t)
return n.apply(this,arguments)}Object(r["a"])(t,[{key:"render",value:function(){return l.a.createElement("div",Object.assign({},this.props,{role:"presentation",className:b.root}))}}])
t.displayName="MenuItemSeparator"
return t}(s["Component"]))||h)||h)},NIsp:function(e,n,t){"use strict"
...
var D=(x=Object(W["a"])(),B=Object(y["j"])(j,K),x(w=B(w=(T=C=function(e){Object(s["a"])(t,e)
var n=Object(l["a"])(t)
function t(e){var o
Object(r["a"])(this,t)
o=n.call(this)
o.handleClick=function(e){var n=o.props,t=n.onSelect,r=n.onClick,a=n.disabled,s=n.value
var l=!o.selected
if(a){e.preventDefault()
return}"undefined"===typeof o.props.selected&&o.setState({selected:l})
if("function"===typeof t){e.persist()
t(e,s,l,Object(i["a"])(o))}"function"===typeof r&&r(e)}
...
var r=this.props,a=r.disabled,i=r.controls,s=r.onKeyDown,l=r.onKeyUp,c=r.type,d=r.href
...
return u.a.createElement(p,Object.assign({tabIndex:"-1"},f,{href:d,role:this.role,"aria-labelledby":this.labelId,"aria-disabled":a?"true":null,"aria-controls":i,"aria-checked":"checkbox"===c||"radio"===c?this.selected?"true":"false":null,onClick:this.handleClick,onKeyUp:Object(M["a"])(l,this.handleKeyUp),onKeyDown:Object(M["a"])(s,this.handleKeyDown),ref:function(e){n._node=e},className:h()(b),onMouseOver:this.handleMouseOver}),this.renderContent())}},{key:"elementType",get:function(){return Object(O["a"])(t,this.props)}},{key:"role",get:function(){switch(this.props.type){case"checkbox":return"menuitemcheckbox"
...
var K=(j=Object(O["a"])(),x=Object(_["j"])(S,T),j(B=x(B=(C=w=function(e){Object(i["a"])(t,e)
var n=Object(s["a"])(t)
function t(e){var r
Object(o["a"])(this,t)
r=n.call(this,e)
...
var t=p.a.codes,o=t.down,a=t.up,i=t.pgup,s=t.pgdn,l=t.tab,c=t.left
if(n===o||n===s){e.preventDefault()
e.stopPropagation()
r.moveFocus(1)
r.hideActiveSubMenu(e)}else if(n===a||n===i){e.preventDefault()
e.stopPropagation()
r.moveFocus(-1)
r.hideActiveSubMenu(e)}else if(n===l||n===c){e.persist()
...
var r=0
return l["Children"].map(t,(function(n){if(!Object(y["a"])(n,["MenuItemSeparator","MenuItem","MenuItemGroup","Menu"]))return
r+=1
...
var n=this.props,t=n.menuRef,o=n.disabled,r=n.label,a=n.trigger,i=n.onKeyUp,s=n.contentRef
var l=this.props["aria-labelledby"]
var u=this.props["aria-controls"]
return c.a.createElement("ul",{role:"menu","aria-label":r,tabIndex:"0",className:T.menu,"aria-labelledby":l||a&&this._labelId,"aria-controls":u,"aria-disabled":o?"true":null,onKeyDown:this.handleMenuKeyDown,onKeyUp:i,ref:function(n){e._menu=n
"function"===typeof t&&t(n)
"function"===typeof s&&s(n)}},this.renderChildren())}},{key:"render",value:function(){var e=this
var n=this.props,t=n.show,o=n.defaultShow,r=n.placement,a=n.withArrow,i=n.trigger,s=n.mountNode,l=n.popoverRef,u=n.disabled,d=n.onDismiss,f=n.onFocus,p=n.onMouseOver,b=n.offsetX,v=n.offsetY
