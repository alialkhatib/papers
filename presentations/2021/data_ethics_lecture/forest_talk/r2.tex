...
\begin{column}{0.7\textwidth}{
  \begin{tikzpicture}[overlay]
      \visible<2->{\node[xshift=1cm] (img00)                 {\only<-4>{\includegraphics[width=0.4\textwidth]{../figures/algo_hiding/IMG_4828}}\only<5->{\includegraphics[width=0.4\textwidth]{../figures/algo_hiding/IMG_4828_grayed}}};}
